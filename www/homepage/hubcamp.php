...
<ul>
  ...
  <li><strong> Plus:</strong> Food buyers and topic experts on food safety, finance &amp; legal issues.</li>
	<li>LA: <strong>Dwight Detter, Kimberly Albright and Don Nishiguchi</strong> lead Whole Foods Market's local sourcing initiatives in Southern California. They have a wealth of experience developing regional supply chains that meet high quality and food safety standards, and can supply the grocery needs of thousands of families from Santa Barbara to San Diego.</li>
...
<ul>
	<li>WED 1/28 NIGHT: Informal welcome for early arrivees</li>
	<li>THU 1/29: Welcome &bull; Focus on Customers and Farmers &bull; Q&amp;A with Chefs &bull; Experts on Food Distribution, Food Safety</li>
	<li>FRI 1/30: Focus on Operations &bull; Experts on Finance, Legal, Operations</li>
    <li>SAT 2/1: 6-month Action Plans</li>
	<li>BEFORE: We will send out business planning "homework" to Hub Camp participants in early January</li>
	<li>AFTER: The Hub Camp alumni peer network offers continuing opportunities for mentorship and business development after the workshops</li>
</ul><br />
<h2>We'll Provide</h2>
<ul><li>Coffee, breakfast, light snacks on Thursday and Friday</li>
  <li>Paper for brainstorming</li>
  <li>Engaging business planning tools</li>
  <li>WiFi and workspace</li>
  <li>Experts with food hub experience </li>
</ul>
<br />
<h2>Packing List</h2>
<ul><li>Laptop or iPad for note taking</li>
  <li>Comfortable clothing</li>
  <li>A camera – the new Grand Rapids Downtown Market is going to bowl you over</li>
  <li>Your favorite pen </li>
</ul>
<br />
<h2>Lodging</h2>
<ul>
	<li>3 nights in Grand Rapids: Thurs, Jan 30th and Fri, Jan 31st, plus we suggest Wed, Jan 29th since we will start early on Thurs</li>
	<li>Once you are accepted into Hub Camp, we will provide you with the group rate for a hotel near the conference space</li>
</ul><br />
<h2>Cost</h2><p>$250 per participant for workshops, with a $150 future credit towards any Local Orbit food hub software per group</p><br />
<p><a style="cursor:hand;cursor:pointer;" onclick="window.open('https://docs.google.com/forms/d/11-Llu9bSh3tbykH-4uGhrBc81Nzq70vSgDSZh-FNa6I/viewform', 'name','width=700,height=400')" class="btn btn_blue">Apply Now</a></p>*/ ?>
