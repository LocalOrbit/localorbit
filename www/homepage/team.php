<? $title='Team'; include('includes/page_start.php'); ?>	
<table>
	<col width="180" />
	<col width="920" />
	<tr>
		<td>
			<? include('includes/nav_company.php'); ?>
		</td>
		</td>
		<td>
			<h1>Management</h1>
			...
			<h3>Erika Block</h3>
			<p>Founder & CEO<br />
			<a href="mailto:erika@localorb.it">erika@localorb.it</a><br />
			</p>
			<br />
