	...
	<tr>
		<td>
			<div id="slides_homepage" class="slides">
				<div class="slides_container">
					...
					<div class="slide">
						<img src="/homepage/img/slideshow/slideshow-new-04.jpg" width="740" height="350" alt="Slide 2" />
						<div class="caption">
				...
				<!--
				core.lo3.homepageStartup();
				//-->
				</script>
				<a href="#!misc-home" class="slideshow_prev"><img src="/homepage/img/slideshow/library/arrow-prev_new.png" alt="Arrow Prev"></a>
				<a href="#!misc-home" class="slideshow_next"><img src="/homepage/img/slideshow/library/arrow-next_new.png" alt="Arrow Next"></a>
			</div>
		</td>
		<td>&nbsp;&nbsp;&nbsp;</td>
		<td style="text-align: center !important;">
			...
			<div class="homepage_msg">
				...
				food hubs<br /> and independent distributors
