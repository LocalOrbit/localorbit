...
<table>
	...
	<tr>
		<td>
			...
			People are hungry for food that's produced by farmers, ranchers and artisans they know and trust. They want to spend a larger share of their food dollars in their own communities.
			Local Orbit's services create stronger, more efficient food networks that can meet the demand for food produced closer to where we live. 
			<br />&nbsp;<br />Our flexible, localized tools are designed to support the businesses and organizations that are rebuilding local and regional supply chains.  
			<br />&nbsp;<br />
	...
	<tr>
		<td>
			<img src="/homepage/img/icon_scarecrow_small.png" class="home_icon" /><h2 class="home_header">Management Team</h2>
			<br />&nbsp;<br />
			<br />&nbsp;<br />
			<div>
