...
*/
  ...
  $first_visit_text = 'Welcome to the MyCustomWidget configuration screen. Do not change anything, if you do not know what you are doing. To create widgets <a href="'.get_option("siteurl").'/wp-admin/themes.php?page='.MCW_get_mainfile_name().'">click here &raquo;</a>  ';
