	...
	function Navigation()
		...
		$switch['guest']
		 ...
		 array('from' => array('/{{regMyAcct}}/',
				       '/{{nodispcart}}/',
				       '/{{loginout}}/'),
		       'to' => array("<li class=\"signupLi\"><a href=\"$base/reg/register.php\"  class=\"signup\" title=\"Sorry, pilot sign up is closed\"><span>sign up</span></a></li>",
				     'display:none;',
				     '<li class="loginLi"><a href="' . $base . '/reg/login2.php" class="login" title="log in to local orbit"><span>log in</span></a></li>'));
		...
		if ($this->usertype == 'buyer')
			$this->globalmenu = preg_replace($switch[$this->usertype]['globalmenu']['from'],
			$switch[$this->usertype]['globalmenu']['to'],
			'<ul><!--To have the rollover effect become the YOU ARE HERE icon simply change out the class in the link   --><li class="knowLi"><a href="{{know-local}}" onclick="addParams(this);" title="know local" class="know {{kl-selected}}"><span>Know Local</span></a></li><li class="SellerStoriesLI"><a href="{{sell-local}}" onclick="addParams(this);" title="sell local" class="SellerStories {{sl-selected}}"><span>Our Sellers</span></a></li><li class="buyLi"><a href="{{buy-local}}" title="buy local" class="buy {{bl-selected}}"><span>Buy Local</span></a></li></ul>');
		else
			$this->globalmenu = preg_replace($switch[$this->usertype]['globalmenu']['from'],
			$switch[$this->usertype]['globalmenu']['to'],
		...
		$this->footerUtilmenu =
		 preg_replace($switch[$this->usertype]['footerUtilmenu']['from'],
			      ...
			      "<ul><li>&copy; 2009</li> <li><a href=\"$base/index.php\" class=\"home\" onclick=\"addParams(this);\" title=\"click to go to's local orbit home page\">Home</a></li> <li><a href=\"$base/about-us/contact.php\">Contact Us</a></li> <li><a href=\"$base/about-us/privacy.php\">Privacy</a></li> <li><a href=\"$base/about-us/tos.php\">Terms of Service</a></li> <li><a href=\"$base/about-us/index.php\">About Us</a></li> <li><a href=\"$base/help.php\">Help</a></li> </ul>");
	    }
