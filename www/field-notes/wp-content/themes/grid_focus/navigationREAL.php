	...
	function Navigation()
		...
		$switch['guest']
		 ...
		 array('from' => array('/{{regMyAcct}}/',
				       '/{{nodispcart}}/',
				       '/{{loginout}}/'),
		       'to' => array("<li class=\"aboutLi\"><a href=\"$base/reg/register.php\" onclick=\"return false;\" class=\"lbOn signup\" title=\"Sorry, pilot sign up is closed\"><span>sign up</span></a></li>",
				     'display:none;',
