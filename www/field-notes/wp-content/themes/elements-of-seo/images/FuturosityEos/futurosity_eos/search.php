...
<?php if (have_posts()) : ?>
		...
		<h2 class="page-title"><?php _e('Search Results for ', 'sandbox') ?> <span id="search-terms">&ldquo;<?php echo wp_specialchars(stripslashes($_GET['s']), true); ?></span>.&rdquo;</h2><div class="excerpt"><p>Look what I found.</p></div>
...
<?php edit_post_link(__('Edit', 'sandbox'), "\t\t\t\t\t<span class=\"edit-link\">", "</span>\n\t\t\t\t\t<span class=\"meta-sep\">|</span>\n"); ?>
					<span class="comments-link"><?php comments_popup_link(__('Add a Comment', 'sandbox'), __('1 Comments', 'sandbox'), __('% Comments', 'sandbox')) ?></span>
				</div>
			</div><!-- .post -->
...
<?php else : ?>
			...
			<div id="post-0" class="post noresults">
				<h2 class="entry-title"><?php _e('Nothing Found', 'sandbox') ?></h2><div class="excerpt"><p>Hmmm. Nothing. I wasn&rsquo;t expecting this.</p></div>
				<div class="entry-content">
