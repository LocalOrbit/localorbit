...
<div class="buttonset">
	...
	<input type="button" class="button_secondary" value="Upload" onclick="core.ui.uploadFrame(document.prodForm,'uploadArea','product.refreshImage(<?=intval($images[0]['pimg_id'])?>,{params});','app/products/save_image','new_image');" />
	<input type="button" id="removeLogo" class="button_secondary" value="Remove Image" onclick="core.doRequest('/products/remove_image',{'pimg_id':document.prodForm.old_pimg_id.value});" /> 
