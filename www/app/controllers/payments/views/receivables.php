...
$payables_table->add(new core_datacolumn('description','Description',false,'27%',			'<b>R-{payable_id}</b><br />{description_html}','{description}','{description}'));
$payables_table->add(new core_datacolumn(null,'Payment Info',false,'27%','{direction_info}','{direction_info}','{direction_info}'));
$payables_table->add(new core_datacolumn('creation_date','Date',true,'14%','{creation_date}','{creation_date}','{creation_date}'));
