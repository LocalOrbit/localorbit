...
$invoices_table->add(new core_datacolumn('invoice_id','Description',true,'17%',			'<b>I-{invoice_id}</b><br />{description_html}','{description}','{description}'));
...
$invoices_table->add(new core_datacolumn('aging','Aging',true,'10%','{aging}','{aging}','{aging}'));
