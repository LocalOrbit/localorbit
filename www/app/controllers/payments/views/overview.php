				...
				<table>
					<tr>
						...
						<td class="field"><select>
							<option>Hub A</option></td>
					</tr>
					<tr>
						<td class="label">Organization:</td>
						<td class="field"><select id="orgSelector" onchange="$('.showOnOrgSelect').show(300);">
							<option>Select Organization</option>
							<option>Buyer A</option></td>
					</tr>
					<tr class="showOnOrgSelect" style="display: none">
						<td class="label">Amount:</td>
						<td class="field"><input></input></td>
					</tr>
					<tr class="showOnOrgSelect" style="display: none">
						<td colspan="2">
							<table class="dt">
								<tr class="dt">
									<th class="dt">Invoice #</th>
									<th class="dt">Date</th>
									<th class="dt">Amount</th>
									<th class="dt">Allocate</th>
								</tr>
								<tr class="dt1">
									<td class="dt">121</td>
									<td class="dt">10/1</td>
									<td class="dt">$150</td>
									<td class="dt"><input></input></td>
								</tr>
								<tr class="dt">
									<td class="dt">122</td>
									<td class="dt">10/3</td>
					...
					<tr>
						<td></td>
						<td>
					<input type="button" class="button_primary" value="Finalize" onclick="$('.showOnOrgSelect').hide(300);$('#orgSelector').val(0);" />
			</td>
					</tr>
				</table>
			</td>
