...
$noncurrent_domains->add(new core_datacolumn('hostname','&nbsp;',false,'20%','<a href="javascript:org.addManagedDomain({domain_id})">Add this market</a>',' ',' '));
...
<div class="buttonset" id="currentButtons">
	<input type="button" class="button_secondary" value="Add New Managed Market" onclick="org.toggleNewHubTable();" />
