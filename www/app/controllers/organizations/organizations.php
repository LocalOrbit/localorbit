...
class core_controller_organizations extends core_controller
{
	...
	function save()
	{
		...
		if(lo3::is_admin())
			$org->import_fields('org_id','name','domain_id','allow_sell','payment_allow_paypal','payment_allow_purchaseorder','buyer_type','profile','product_how','public_profile','facebook','twitter', 'payment_entity_id');
		else if(lo3::is_market())
			$org->import_fields('org_id','name','allow_sell','profile','payment_allow_paypal','payment_allow_purchaseorder','product_how','public_profile','facebook','twitter', 'payment_entity_id');
		else
