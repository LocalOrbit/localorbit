...
{	
	...
	function save()
	{
		...
		if(lo3::is_admin())
			$org->import_fields('org_id','name','domain_id','allow_sell','payment_allow_paypal','payment_allow_purchaseorder','buyer_type','profile','product_how','public_profile','facebook','twitter');
		else if(lo3::is_market())
			$org->import_fields('org_id','name','allow_sell','profile','payment_allow_paypal','payment_allow_purchaseorder','product_how','public_profile','facebook','twitter');
		else
			$org->import_fields('org_id','name','profile','product_how','public_profile','facebook','twitter');
