...
class core_model_base_domains extends core_model
{
	function init_fields()
	{
		...
		$this->add_field(new core_model_field(75,'payment_allow_paypal_popup','int',8,'','domains'));
		$this->add_field(new core_model_field(76,'payment_default_paypal_popup','int',8,'','domains'));
		$this->init_data();
	}
}
?>