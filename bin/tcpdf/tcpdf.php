...
class TCPDF {
	 ...
	 * @param $dest (string) Destination where to send the document. It can take one of the following values:<ul><li>
	...
	public function Output($name='doc.pdf', $dest='I') {
		...
		/* This would give huge file names since the whole path is passed in
		 if ($dest{0} != 'F') {
