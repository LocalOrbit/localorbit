module AddressHelper
  ExcludedUsStates = %w(AA AK AE AP AS GU MP PR UM VI)
  IncludedCaProvinces = %w(QC ON BC)
  ...
  def options_for_state_select
    ...
    ca_provinces = Country["CA"].states.select do |s| IncludedCaProvinces.include?(s) end
