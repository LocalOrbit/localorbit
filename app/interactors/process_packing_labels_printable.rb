class ProcessPackingLabelsPrintable
  ...
  def perform
    packing_labels_printable, request, product_labels_only, product_label_format = require_in_context(:packing_labels_printable_id, :request, :product_labels_only, :product_label_format)
    ...
    pdf_result = PackingLabels::Generator.generate(orders: seller_orders, request: request, product_labels_only: product_labels_only, product_label_format: product_label_format)
