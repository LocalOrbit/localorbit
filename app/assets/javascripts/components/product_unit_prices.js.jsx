        ...
        <td colSpan="2">
          <div style={{float:"left", background:"#F7F7F7", width:"100%", borderRadius: "4px", border:"1px solid #D1D1D1", padding: "4px 0"}}>
            <div style={{float:"left", width:"50%", textAlign:"center"}}>
              <input style={{width: "60px"}} type="number" value={this.state.cartItemQuantity}/>
            </div>
            <div style={{float:"left", width:"50%", textAlign:"center", padding: "10px 0"}}>
              {this.props.total_price} <a style={{display: (this.state.cartItemQuantity > 0) ? "" : "none"}} className="font-icon icon-clear" href="#"></a>
            </div>
          </div>
        </td>
      </tr>
