class Product < ActiveRecord::Base
  ...
  attr_accessor :sibling_id, :sibling_name, :sibling_short_description, :sibling_unit_id, :sibling_unit_description, :sibling_product_code, :sibling_unit_quantity, :skip_validation, :consignment_market
