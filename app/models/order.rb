class Order < ActiveRecord::Base
  ...
  def add_cart_item(cart_item, deliver_on)
    category_fee_pct = !cart_item.product.prices.nil? && !cart_item.product.prices.visible.empty? && cart_item.product.prices.visible.first.fee == 1 ? cart_item.product.category.level_fee(self.market.id) : 0
