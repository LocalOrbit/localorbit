class OrdersController < ApplicationController
  ...
  def create
    if params[:prev_discount_code] != params[:discount_code]
      ...
      @placed_order = PaymentProvider.place_order(current_market.payment_provider, buyer_organization: current_cart.organization,
                                                  user: current_user, order_params: order_params, cart: current_cart)
