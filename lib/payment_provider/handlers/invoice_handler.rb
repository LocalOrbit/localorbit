  ...
  module Handlers
    ...
    # KXM Inheritance?  Where should the class reside?
      ...
      def self.invoice_payment_succeeded(event_params)
        ...
        # Payment.create!(payment_params(subscriber, bank_account, event_params))
      ...
      def payment_params(subscriber, bank_account, event_params)
        # KXM This ought to handle any payment status (paid, failed, etc)
        {
