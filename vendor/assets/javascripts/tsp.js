...
function formatDirections(gdir, mode) {
	...
	dragStr += "<li id='" + i + "' class='ui-state-"
	  + (i ? "default" : "disabled") + "'>"
	  + "<table class='dragTable'><tr><td class='left'></td><td class='middle'>" + headerStr + "</td><td class='right'>"
	...
	dragStr += "<li id='" + 0 + "' class='ui-state-disabled'>"
	  + "<table class='dragTable'><tr><td></td><td>" + headerStr
	  + "</td></tr></table></li>"; 
	...
	dragStr += "<li id='" + gdir.legs.length + "' class='ui-state-disabled'>"
	  + "<table class='dragTable'><tr><td></td><td>"
