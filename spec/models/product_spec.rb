  ...
  describe "custom seller info" do
    ...
    describe "#who_story" do
      it "returns custom who story when available" do
        product = build(:product, organization: organization, who_story: "prod-who")

        expect(product.who_story).to eq("prod-who")
      end

      it "returns the organization's who story when custom who story unavailable" do
        product = build(:product, organization: organization, who_story: nil)
    ...
    describe "#how_story" do
      it "returns custom how story when available" do
        product = build(:product, organization: organization, how_story: "prod-how")

        expect(product.how_story).to eq("prod-how")
      end

      it "returns the organization's how story when custom how story unavailable" do
        product = build(:product, organization: organization, how_story: nil)
    ...
    describe "#location" do
      it "returns custom location when available" do
        organization_other_location = build(:location, organization: organization)

        product = build(:product, organization: organization, location: organization_other_location)
      ...
      it "returns the organization's default location when custom location unavailable" do
        organization_default_location = create(:location, :default_billing, organization: organization)

        product = build(:product, organization: organization, location: nil)
