...
describe UnderwriteOrganization do
  subject(:interactor) { UnderwriteOrganization.new(balanced_customer: balanced_customer, representative_params: representative_params, organization: org) }
