...
feature "Payments to Sellers on plans with Automatic Payments", :js, :focus  do
  ...
  it "displays all pending Seller payments info and lets you pay one of the Sellers" do
    ...
    verify_seller_payment_section(
      ...
      bank_accounts: [
        ["ACH: East Bank - *********0006",             11],
        ["ACH: North Bank - *********0003",            12],
      ]
    )
    ...
    verify_seller_payment_section(
      ...
      bank_accounts: [
        ["ACH: East Bank - *********0004",              7],
        ["ACH: North Bank - *********0002",             8],
      ]
    )
    ...
    # Pay!
    section.select_bank_account "ACH: North Bank - *********0002"
    ...
    expect(mail.body).to match(/payment was sent to.*Organization 7/i)
  ...
  def verify_seller_payment_section(seller_name:, orders:, totals:, bank_accounts:)
