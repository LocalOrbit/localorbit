...
feature "Viewing orders" do
  ...
  let!(:order2) {create(:order, :with_items, payment_method: "purchase order", organization: organization, market: market, delivery_fees: 10, invoiced_at: 1.day.from_now, invoice_due_date: 30.days.from_now) }
