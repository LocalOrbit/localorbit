...
feature "View a products story", js: true do
  ...
  let!(:org1)      { create(:organization, :seller, :single_location, markets: [market], name: "Funny Farm", who_story: "Chevy Chase", how_story: "Magic") }
  ...
  context "fall through to organization stories" do
    scenario "view the 'who' story" do
      product = Dom::ProductListing.find_by_name(product1.name)
