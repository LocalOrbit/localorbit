...
describe Admin::ReportsController do
  ...
  it_behaves_like "an action that is accessible to all roles", lambda { get :show, id: "purchases-by-product" }
  it_behaves_like "an action that is accessible to all roles", lambda { get :show, id: "total-purchases" }
end
